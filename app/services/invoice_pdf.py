...
def generate_invoice_pdf(record: BillingRecord, tenant: Tenant) -> io.BytesIO:
    ...
    story.append(
        Paragraph(
            "Bill To:",
            ParagraphStyle("BillTo", parent=styles["Normal"], fontSize=10, textColor=colors.grey),
        )
    )
    ...
    story.append(
        Paragraph(
            "Thank you for your business. This invoice was generated automatically by UniHR.",
            footer_style,
        )
    )
